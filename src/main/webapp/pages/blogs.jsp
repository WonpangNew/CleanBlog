            ...
            <div class="col-lg-3 col-md-3" style="word-break:break-all;">
                <div>
                    <div id='tag-cloud'>
                        ...
                        <a href="/category?category=持续集成" style="color: #c05cb8">持续集成</a>
                        <a href="/category?category=大数据" style="color: #c0342f">大数据</a>
                    </div>
                </div>
                <div style="margin-top: 10px;" ng-app="">
                    <input type="text" style="width: 213px;" ng-model="name" placeholder="search...">
                    <a href="/search?blogName={{name}}" class="btn btn-primary active button-search" style="float: right;" role="button">搜索</a>
                </div>
            </div>
